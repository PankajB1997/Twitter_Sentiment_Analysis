...
import org.apache.spark.ml.feature.{IndexToString, StringIndexer, StandardScaler}
...
//    val lines = context.textFile("/Users/ronaldlim/Downloads/Twitter_Sentiment_Analysis-master/raw_unlabeled_data/tweets_amazon.csv")
////    val lines = context.textFile("dbfs:/FileStore/tables/tweets_large_32M.csv")
//    val stopwords = context.textFile("/Users/ronaldlim/Downloads/Twitter_Sentiment_Analysis-master/preprocessor/src/main/resources/stopwords.txt")
////    val stopwords = context.textFile("dbfs:/FileStore/text/stopwords.txt")
//    val outputfile = "/Users/ronaldlim/Downloads/Twitter_Sentiment_Analysis-master/preprocessor/src/main/resources/preprocessed_tweets.csv"
